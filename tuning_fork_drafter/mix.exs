defmodule TuningForkDrafter.MixProject do
  ...
  defp deps do
    [
      ...
      family(:tuning_fork_composer, "~> 0.1.10", []),
      family(:tuning_fork_speaker, "~> 0.1.10", optional: true),
      family(:tuning_fork_samples, "~> 0.1.10", optional: true),
      family(:tuning_fork_midi, "~> 0.1.10", []),
